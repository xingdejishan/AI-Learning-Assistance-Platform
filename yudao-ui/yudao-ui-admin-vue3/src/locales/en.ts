export default {
  ...
  login: {
    platformName: 'AI Study Platform',
    welcome: 'Welcome to the AI Study and Career Growth Platform',
    message:
      'An admin console for intelligent learning, skill growth, and career readiness for college students',
