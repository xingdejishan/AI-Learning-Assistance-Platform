    ...
    <el-col :lg="10" :md="24">
      <ContentWrap title="学习画像">
        <el-descriptions :column="1" border>
          ...
          <el-descriptions-item label="连续学习"
            >{{ profile.currentStreak || 0 }} 天</el-descriptions-item
          >
          <el-descriptions-item label="最长连续"
            >{{ profile.longestStreak || 0 }} 天</el-descriptions-item
          >
      ...
      <ContentWrap title="AI 成长报告">
        ...
        <div v-else>
          ...
          <el-descriptions :column="1">
            ...
            <el-descriptions-item label="风险提醒">{{
              report.riskReminder || '暂无明显风险'
            }}</el-descriptions-item>
          </el-descriptions>
        </div>
      </ContentWrap>
